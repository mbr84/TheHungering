...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.step = function () {
	  ...
	  if (Math.random() * 1000 >= 995 && this.objects.length > 4) {
	    this.addMonster();
	  }
	  this.growMonsters()
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	debugger
	  if (this.radius > otherObject.radius) {
	    const growthRatio = otherObject.radius / this.radius
	    this.radius += 2 * growthRatio;
	    ...
	    const growthRatio = this.radius / otherObject.radius
	    this.radius -= 1;
	    otherObject.radius += 2 * growthRatio;
